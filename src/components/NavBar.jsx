...
export default function NavBar() {
  ...
  return (
    <div className={top}>
            <div className="work">
            <NavLink className="navbar-brand fw-600 logo" to="/"><FaSnowflake/> VOL-LINK</NavLink>
      ...
      <NavLink to="/profile" className="btn btn-outline-dark " ><i class="fa fa-solid fa-user"></i>&nbsp; Profile</NavLink>
      <NavLink to="/" className="btn btn-outline-dark"  data-bs-toggle="button" ><i className="fa fa-sign-in me-1"></i>Login</NavLink>
